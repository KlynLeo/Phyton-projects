...
def add():   
    CSV.initialize_csv()
    CSV.add_entry(get_date("Enter the date of the transaction(dd-mm-yyyy) or enter for today's date ", allow_default=True), get_amount(), get_category(), get_description())
